...
namespace OmniumLessons
{
    ...
    public class CharacterFactory : MonoBehaviour
    {
        ...
        public void ReturnCharacterToPool(Character character)
        {
            ...
            // Обычно здесь объект выключают, чтобы его не было видно на сцене пока он в пуле
        ...
        public Character CreateEnemy(Vector3 position)
        {
            // Используем уже существующую логику создания/получения из пула
            Character enemy = CreateCharacter(CharacterType.DefaultEnemy);
            ...
            if (enemy != null)
            {
                ...
                // Включаем (на случай если в пуле он был выключен)
